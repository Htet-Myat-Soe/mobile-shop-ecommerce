<div>
    <div class="container">
        <div class="row my-5 d-flex justify-content-between">
            ...
            <button class="btn btn-primary" wire:click.prevent="cancelOrder">Cancel Order</button>
            @endif
        </div>
        @if (Session::has('order_canceled'))
        <div class="alert alert-success">
            {{Session::get('order_canceled')}}
        </div>
        @endif
        <div class="row">
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                    ...
                    <div id="collapseDetails" class="accordion-collapse collapse" aria-labelledby="headingDetails" data-bs-parent="#accordionExample">
