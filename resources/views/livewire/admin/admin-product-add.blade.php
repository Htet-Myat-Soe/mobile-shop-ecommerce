        ...
        <form wire:submit.prevent="storeProduct" enctype="multipart/form-data">
                        ...
                        <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion"  wire:ignore.self>
                            <div class="p-4 border-top">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="productname" name="name" wire:model="name" type="text" class="form-control"> </div>
                                                @error('name')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="productname" name="sku" wire:model="sku" type="text" class="form-control"> </div>
                                                @error('sku')
                                                    <p class="text-danger">{{$message}}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="manufacturername" name="regular_price" wire:model="regular_price" type="text" placeholder="$" class="form-control"> </div>
                                                @error('regular_price')
                                                    <p class="text-danger">{{$message}}</p>
                                                @enderror
                                            </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="manufacturerbrand" name="sale_price" wire:model="sale_price" type="text" placeholder="$" class="form-control"> </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select1" wire:model="category_id">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select1" name="stock" wire:model="stock">
                                                    <option>Select</option>
                                    ...
                                    <div class="mb-0" wire:ignore>
                                        ...
                                        <textarea class="form-control" id="short_desc" name="short_desc" wire:model="short_desc" rows="4"></textarea>
                                    </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="addproduct-metadata-collapse" class="collapse"  wire:ignore.self data-bs-parent="#addproduct-accordion">
                            <div class="p-4 border-top">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="metatitle" name="image" wire:model="image" type="file" class="form-control"> </div>

                                            </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="metakeywords">Quantity</label>
                                                <input id="metakeywords" name="qty" wire:model="qty" type="number" class="form-control"> </div>
                                                @error('qty')
                                                    <p class="text-danger">{{$message}}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="mb-0"  wire:ignore>
                                        ...
                                        <textarea class="form-control" name="desc" wire:model="desc" id="desc" rows="4"></textarea>
                                        @error('desc')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div id="addproduct-img-collapse" class="collapse"  wire:ignore.self data-bs-parent="#addproduct-accordion">
                            <div class="p-4 border-top">
                                <div class="dropzone">
                                    <div class="fallback">
                                        <input name="file" type="file" multiple="multiple" wire:model="images"> </div>
                                        @if ($images)
            ...
            <div class="row my-4">
                <div class="col text-end">
                    ...
                    <button type="submit" class="btn btn-dark" > <i class="uil uil-file-alt me-1"></i> Save </button>
                </div>
                <!-- end col -->
            </div>
        </form>
