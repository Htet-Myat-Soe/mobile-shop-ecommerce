                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <h4 class="mb-1 mt-1">$<span data-plugin="counterup">{{$totalRevenue}}</span></h4>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{count($orders)}}</span></h4>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{count($users)}}</span></h4>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-4">
                                    <div class="mt-4 mt-sm-0">
                                        <img src="{{asset('admin_assets/images/setup-analytics-amico.svg')}}" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end card-body-->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-centered table-nowrap">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width: 20px;"><img src="{{asset('admin_assets/images/users/avatar-4.jpg')}}" class="avatar-xs rounded-circle " alt="..."></td>
                                                <td>
