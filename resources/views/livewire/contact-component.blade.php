					...
					<div class="wrap-contacts ">
						<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
							<div class="contact-box contact-form">
                                ...
                                @endif
								<form name="frm-contact" wire:submit.prevent="sendContactMessage">
									...
									<input type="submit" name="ok" class="bg-dark" value="Submit" >
						...
						<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
							<div class="contact-box contact-info">
								<div class="wrap-map">
									<iframe src="{{$setting->map}}" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
								</div>
